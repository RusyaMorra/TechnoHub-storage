...
<div class="BlocksLogo">
                    <h1><?php the_field('footage_name')?><h1>
                </div>
                <div class="ProjectContainer">
                        <div class="ProjectVideo">
                            <iframe width="1280" height="720" src="<?php the_field('footage_href')?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></iframe>
                        </div>
						<!-- uSocial -->
                       ...
                       <div class="ya-share2 des-none"  data-title="<?php the_field('footage_name')?>" data-size="m" data-image="<?php the_field('footage_pic')?>"   data-curtain data-services="vkontakte,facebook,odnoklassniki,telegram,viber,whatsapp"></div>

                   
                     <p class="work-page-description"><?php the_field('footage_text') ?></p>


                     <div class="BlocksLogo ">
                        <p>Вы можете заказать у нас, используйте Калькулятор расчета!</p>
                    </div>
                    <a href="#iw-modal"><div class="ProjectButton change-proj-button">Скачать</div></a>
