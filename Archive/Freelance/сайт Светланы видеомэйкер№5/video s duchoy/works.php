                ...
                <div class="BlocksLogo">
                 ...
                 <div class="container-text-gl">
                        ...
                        <div class="text-gl">
                            ...
                            <h1 data-aos="fade-up" class="heading-how-to">наши <span>проекты</span> </h1>
...
<div class="Productsingle ">
            <div class="ProductLogo make-white"><a  class="a-link-blog" href="<?php the_permalink();  ?>" title=""><?php the_field('project_head')?></a></div>
                <div class="ProductImg"><img src="<?php the_field('project_image')?>" alt=""></div>
                
                <div class="ProductHref"><a  href="<?php echo get_permalink();?>" class="ProductButton" style="text-decoration:none;">Приобрести</a></div>
