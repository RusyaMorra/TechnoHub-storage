                 ...
                 <div class="container-text-gl">
                      ...
                      <div class="text-gl">
                        ...
                        <img src="<?php the_field('img')?>" alt="">
                            ...
                            <h1 data-aos="fade-up" class="heading-how-to">У нас есть <span>большой выбор футажей</span> </h1>
...
<div class="Productsingle ">
            <div class="ProductLogo make-white"><a  class="a-link-blog" href="<?php the_permalink();  ?>" title=""><?php the_field('footage_name')?></a></div>
                <div class="ProductImg"><img src="<?php the_field('footage_pic')?>" alt=""></div>
                
                <div class="ProductHref"><a  href="<?php echo get_permalink();?>" class="ProductButton" style="text-decoration:none;">скачать...</a></div>
